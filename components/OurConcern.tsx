      ...
      <div className="grid grid-cols-2 items-stretch gap-3 sm:gap-4 md:grid-cols-3 lg:grid-cols-6">
        {concernLogos.map((c) => (
          <a
            ...
            className="group flex flex-col items-center gap-2 rounded-2xl border border-hairline bg-white px-2.5 py-4 text-center transition-shadow hover:shadow-[0_8px_24px_rgba(15,53,31,0.10)] sm:px-3"
          >
            <div className="flex h-14 w-14 shrink-0 items-center justify-center sm:h-16 sm:w-16">
              <img
                ...
                loading="lazy"
                draggable={false}
                className="max-h-14 max-w-14 object-contain transition-transform duration-300 group-hover:scale-105 sm:max-h-16 sm:max-w-16"
              />
            </div>
