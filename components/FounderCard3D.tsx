      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 z-[2] overflow-hidden rounded-3xl border border-black/[0.06] bg-white shadow-[0_4px_24px_rgba(15,53,31,0.10),0_1px_4px_rgba(15,53,31,0.04)] [backface-visibility:hidden]">
            <div className="absolute inset-[10px] overflow-hidden rounded-[18px] bg-deep">
              <img
                src={avatar}
                alt={founder.name}
                loading="lazy"
            ...
            <div className="absolute inset-x-0 bottom-0 z-[3] p-4 pb-4 sm:p-5 sm:pb-4.5">
              <div className="mb-1 flex items-center gap-1.5">
                <span className="text-[16px] leading-tight font-extrabold text-white sm:text-[18.5px]">
                  {founder.name}
                </span>
                <SealCheck size={17} weight="fill" className="shrink-0 text-[#8fe0b4] sm:size-[19px]" />
              </div>
              <p className="mb-3 line-clamp-2 text-[11.5px] leading-snug text-white/72 sm:mb-3.5 sm:text-[12.5px]">
                {founder.tagline}
              </p>
              <div className="flex items-center gap-2">
                <span className="inline-flex items-center gap-1.5 text-[10.5px] font-bold tracking-[0.02em] text-white/80 sm:text-[11.5px]">
                  {founder.suffix}
                </span>
                <span className="ml-auto shrink-0 rounded-full border border-white/15 bg-white/12 px-3 py-1.5 text-[10.5px] font-bold whitespace-nowrap text-white backdrop-blur-sm sm:px-3.5 sm:text-[12px]">
                  {founder.role}
                </span>
              </div>
            </div>
